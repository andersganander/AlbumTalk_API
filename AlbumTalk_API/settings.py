"""
Django settings for AlbumTalk_API project.
...
SECRET_KEY = 'django-insecure-_s&lbpp5+nu3b*(3zwbzj7kl(bchejnm+#j!u%^4p6+1b+#j87'
...
# OSÄKER PÅ OM DEN HÄR SKA VARA MED (KANSKE FÖR ATT LÖSA CORS-PROBLEM ?)
...
ROOT_URLCONF = 'AlbumTalk_API.urls'
